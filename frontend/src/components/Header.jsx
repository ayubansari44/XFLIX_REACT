    ...
    return (
        <div>
            <Box sx={{
                ...
                size="small"
                inputProps={{style: {fontSize: 18, borderRadius:5, color:"white"}}} 
                InputProps={{
                endAdornment: (
                                ...
                                >
                                    ...
                                    <ThemeProvider theme={theme}>
                                        <DesktopDatePicker
                                            ...
                                            renderInput={(params) => <TextField helperText="This will be used to sort videos" {...params}  sx={{
                  svg: { color },
                  input: { color },
                  label: { color }
                }}/>}
                        ...
                        <DialogActions className="upload-btn-groups">
                            ...
                            <Button id="upload-btn-cancel" variant="text" onClick={handleModalClose} >Cancel</Button>
                        </DialogActions>
                </Dialog>
                {/* <div>
                    <h3>last section</h3>
